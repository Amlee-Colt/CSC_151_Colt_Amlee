...
public class Main {
    public static void main(String[] args) throws Exception{
        ...
        if (Physics.getDistance(Physics.getLightSpeedInMPH(), Physics.getTimeFromSunToEarthInHours()) != Physics.getKnownDistanceToEarth()) {
            Physics.logEarthToSunInvalidDistance();
        } else {
            System.out.println("The calculated distance from the sun equals the known value we expected.");
        }
